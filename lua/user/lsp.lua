...
local function attach_java_keymaps(bufnr)
  ...
  buf_map(bufnr, { 'n', 'x' }, '<leader>jv', '<cmd>JavaRefactorExtractVariable<CR>', 'Java: Extract variable')
  buf_map(bufnr, { 'n', 'x' }, '<leader>jV', '<cmd>JavaRefactorExtractVariableAllOccurrence<CR>', 'Java: Extract variable (all)')
  buf_map(bufnr, { 'n', 'x' }, '<leader>jc', '<cmd>JavaRefactorExtractConstant<CR>', 'Java: Extract constant')
  buf_map(bufnr, { 'n', 'x' }, '<leader>jm', '<cmd>JavaRefactorExtractMethod<CR>', 'Java: Extract method')
  buf_map(bufnr, { 'n', 'x' }, '<leader>jf', '<cmd>JavaRefactorExtractField<CR>', 'Java: Extract field')
