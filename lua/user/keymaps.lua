...
leader_map('n', '<leader>ghs', '<cmd>Gitsigns stage_hunk<cr>', 'Git: Stage hunk')
keymap('v', '<leader>ghs', '<cmd>Gitsigns stage_hunk<cr>', { desc = 'Git: Stage hunk' })
leader_map('n', '<leader>ghr', '<cmd>Gitsigns reset_hunk<cr>', 'Git: Reset hunk')
keymap('v', '<leader>ghr', '<cmd>Gitsigns reset_hunk<cr>', { desc = 'Git: Reset hunk' })
leader_map('n', '<leader>ghu', '<cmd>Gitsigns undo_stage_hunk<cr>', 'Git: Undo stage hunk')
leader_map('n', '<leader>ghp', '<cmd>Gitsigns preview_hunk<cr>', 'Git: Preview hunk')
leader_map('n', '<leader>ghb', '<cmd>Gitsigns blame_line<cr>', 'Git: Blame line')
leader_map('n', '<leader>ghd', '<cmd>Gitsigns diffthis<cr>', 'Git: Diff this')
...
leader_map('n', '<leader>fa', function()
  require('user.telescope_search').find_all_files()
...
leader_map('n', '<leader>fg', function()
  require('user.telescope_search').live_grep()
end, 'Live Grep')
